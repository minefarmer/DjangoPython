...
# # raise NameError  130
# name = '123'
# raise NameError('this is a name error')  # Traceback (most recent call last):
#                                         # File "/home/carl/Github/DjangoPython/Django Python Class Notes/TryRxceptFinal.py", line 132, in <module>
...
try:
    num = 5 / 0  # An error
                    # Traceback (most recent call last):
                    # File "/home/carl/Github/DjangoPython/Django Python Class Notes/TryRxceptFinal.py", line 142, in <module>
                    #     num = 5 / 0
                    # ZeroDivisionError: division by zero
except:
    print('An error')
